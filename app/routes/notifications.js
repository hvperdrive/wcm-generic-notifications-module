...
module.exports = function(app) {
	...
	app.route(baseUrl + "/mappers").get(ProfileSecurity, MethodSecurity.read, PermissionsSecurity, NotificationsController.list);
	app.route(baseUrl + "/emitters").get(ProfileSecurity, MethodSecurity.read, PermissionsSecurity, NotificationsController.list);
